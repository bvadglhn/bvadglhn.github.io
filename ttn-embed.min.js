...
function ClockClock( targetElementIdx, hour, minute, second, date, text, url ) {
  ...
  this.template = tmpl(
    '<div class="ttn-thetimenow-clock" style="background-color: <%= backgroundColor %>; border: 1px solid <%= borderColor %>; color: <%= fontColor %>; font-size: <%= fontSize %>px; font-family: Arial, sans-serif;">' +
...
function doJsonpRequest( params, callback ) {
  ...
  // construct URL
  url = 'ttn-embed-js.php?' + queryString + '&callback=' + callback;
...
(function() {
  ...
  styleTag.setAttribute( "href", 'ttn-embed.css' );
